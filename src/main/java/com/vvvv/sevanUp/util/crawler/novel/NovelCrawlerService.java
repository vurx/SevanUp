package com.vvvv.sevanUp.util.crawler.novel;
...
public class NovelCrawlerService {
    private Map<String, NovelCrawler> comicCrawlerMap;
    @Autowired
    public void setComicCrawlers(List<NovelCrawler> comicCrawlers) {
    ...
    public List<Map<String, String>> qryComicChapter(String comicId, String starSourceCode) {
        NovelCrawler comicCrawler = comicCrawlerMap.get(starSourceCode);
