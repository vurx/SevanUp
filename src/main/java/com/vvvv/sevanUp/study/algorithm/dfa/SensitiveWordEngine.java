...
public class SensitiveWordEngine {
     ...
     * @return
     */
    public static Map initKeyWord(List<SmsBlackDict> sensitiveWords) {
        try {
    ...
    public static void main(String[] args) {
        SmsBlackDict s1 = new SmsBlackDict();
        SmsBlackDict s2 = new SmsBlackDict();
        s1.setName("毛泽东");
        s2.setName("日本鬼子");
        List<SmsBlackDict> list = new ArrayList<>();
        list.add(s1);
        list.add(s2);
        initKeyWord(list);
        SensitiveWordEngine sss = new SensitiveWordEngine();

        System.out.println(sss.getWordSize());
        System.out.println(sss.isContaintSensitiveWord("n日本鬼子来了毛泽东", 2));
//        System.out.println(sss.isContaintSensitiveWord("n日本鬼子来了毛泽东", 2));
    }
}